...
| Boundary             | `cmd/lmm/boundary_test.go`'s `TestCheckBoundary` enforces the hard rule directly — `cmd/lmm` may import only `internal/{app,core,domain,source,serve}` — with no allow-list escape hatch; a new dependency either belongs in that list or the logic it needs moves into `internal/core`. `internal/serve/boundary_test.go` mirrors it one layer down: `internal/serve` may import only `internal/{app,core,domain}`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
