...
(name, author, version, summary, URL) is fetched from it automatically
and applied to any field you didn't explicitly override with --name,
--author or --version. Re-linking moves the mod to its new source:id in
the database and profile - it is not merely a display change.
