...
the game to its root (`lmm purge --game <id>`, then `lmm game edit <id>
--mod-path <install path>`, then `lmm deploy`; the warning lists every
step), or run `lmm game edit <id> --adapter generic-files` to keep it as it
...
| `lmm game edit <game-id> --mod-path <dir>`                | Set the directory mods deploy into — the repair for a mod path that no longer exists, which `lmm game show`, `lmm game list` and `lmm status` flag (relative to the install path unless absolute; refused while files are deployed, so purge first)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
