...
| `lmm deploy`                                              | Deploy all enabled mods from cache. Skips a mod the profile marks `disabled: true` and never takes files down: one still deployed is named, and `lmm profile apply` removes it                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
