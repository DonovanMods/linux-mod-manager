...
| `--json`      |       | Output JSON instead of text for every command; mutating commands print their result, `--dry-run` prints the plan; never prompts — see [JSON output](#json-output) |
