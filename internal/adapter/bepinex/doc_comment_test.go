...
// §4), matching internal/adapter and internal/adapter/icarus' own copies:
// every exported identifier declared in this package's non-test files must
// carry a leading doc comment.
