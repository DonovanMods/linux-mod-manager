...
func TestIngestLocalToCacheDirectory(t *testing.T) {
	...
	result, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, modDir, nil)
...
func TestIngestLocalToCacheDirectory_ChecksumDeterministicAndDriftSensitive(t *testing.T) {
	...
	first, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, modDir, nil)
	require.NoError(t, err)
	require.NotEmpty(t, first.Checksum)

	unchanged, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, modDir, nil)
	require.NoError(t, err)
	...
	contentDrift, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, modDir, nil)
	require.NoError(t, err)
	...
	memberDrift, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, modDir, nil)
	require.NoError(t, err)
...
func TestIngestLocalToCacheDirectory_ReingestDropsRemovedMembers(t *testing.T) {
	...
	second, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, modDir, nil)
	require.NoError(t, err)
	...
	fresh, err := svc.ingestLocalToCache(context.Background(), freshCache, game, mod, file, modDir, nil)
	require.NoError(t, err)
...
func TestIngestLocalToCacheArchiveCopyMode(t *testing.T) {
	...
	result, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, archive, nil)
	require.NoError(t, err)
...
func TestIngestLocalToCacheArchiveCopyModeUsesDeclaredFileName(t *testing.T) {
	...
	result, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, tempFile, nil)
	require.NoError(t, err)
	assert.Equal(t, 1, result.FilesExtracted)
...
func TestIngestLocalToCacheMissingPath(t *testing.T) {
	...
	_, err := svc.ingestLocalToCache(context.Background(), gameCache, game, mod, file, filepath.Join(t.TempDir(), "gone"), nil)
	assert.Error(t, err)
}
...
func TestIngestLocalToCacheDirectory_CancelledMidCopy(t *testing.T) {
	...
	result, err := svc.ingestLocalToCache(ctx, gameCache, game, mod, file, modDir, nil)
