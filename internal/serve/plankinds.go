...
// Plan and Apply, and how its Apply runs. Eight kinds are registered today:
// deploy, install, uninstall, updates, switch, profile_apply and verify_fix
// here, plus the two plan-free toggles in kind_toggle.go.
//
