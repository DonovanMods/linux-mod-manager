...
*What fraction of paks are convertible?* **In this corpus: 11/11 readable,
...
### 4. Asset probe
*Does the inferred asset layout hold; do assets fit the exmodz filter?*
...
*What can't EXMOD express, and how often does it occur?* Corpus
...
### 6. Seam validation
*Does a synthesized `.exmodz` flow through the real pipeline unchanged?*
